...
const ViewServiceCenterAppointments = () => {
  ...
  const retrieveAllServiceAppointments = async () => {
    const response = await axios.get(
      "http://localhost:8080/api/service/appointment/fetch/service-center-wise?serviceCenterId=" +
        serviceCenter.id
    );
  ...
  const cancelAppointment = (appointmentId) => {
    fetch(
      "http://localhost:8080/api/service/appointment/close?appointmentId=" +
        appointmentId,
      {
        method: "GET",
        headers: {
  ...
  const addAppointmentJob = (e) => {
    ...
    fetch("http://localhost:8080/api/service/appointment/job/card/add", {
      method: "POST",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
  ...
  const updateAppointmentServicingStatus = (e) => {
    ...
    fetch(
      "http://localhost:8080/api/service/appointment/service/status/update?appointmentId=" +
        appointmentId +
        "&status=" +
        status,
      {
